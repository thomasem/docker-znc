...
First you'll want to generate your configuration. This image will mount a volume, `/var/lib/znc`, where it will place all of your ZNC configuration files. If you're interested in the why, here's a quick read for your: https://docs.docker.com/userguide/dockervolumes/.
```
